...
static void my_application_activate(GApplication* application) {
  ...
  // Avoid adding a duplicate GtkHeaderBar on Linux since Flutter provides
  // its own integrated cyberpunk WindowTitleBar and BrowserTabBar.
  gtk_window_set_title(window, "CPRedux Desktop");
